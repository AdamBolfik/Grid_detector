...
void Tracker::trackFilteredObject(int &x, int &y, Mat threshold, Mat &cameraFeed){
...
void Tracker::on_trackbar( int, void* )
...
vector<Point2f> Tracker::get_positions(Mat &img, const int color){
